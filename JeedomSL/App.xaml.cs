...
namespace JeedomSL
{
    public partial class App : Application
    {
        ...
        private static MessageViewModel message = null;
        private static CheckUpdateViewModel checkUpdate = null;
        private static MenuViewModel menu = null;
        private static ScenarioViewModel scenario = null;
        public static string JsonMessage = "";
        public static string JsonDashboard = "";
        public static string JsonScenario = "";
        ...
        public static CheckUpdateViewModel CheckUpdate
        {
            get
            {
                // Différer la création du modèle de vue autant que nécessaire
                if (checkUpdate == null)
                    checkUpdate = new CheckUpdateViewModel();
        ...
        public static ScenarioViewModel Scenario
        {
            get
            {
                // Différer la création du modèle de vue autant que nécessaire
        ...
        public static MessageViewModel Messages
        {
            get
            {
                // Différer la création du modèle de vue autant que nécessaire
        ...
        {
            //  String result = await LoadPlugin();
            //   JObject res = JObject.Parse(result);
            //   Pluggins myPlug = JsonConvert.DeserializeObject<Pluggins>(result);
            //    MessageBox.Show(res.ToString());

       /*     var storageFile =
  await Windows.Storage.StorageFile.GetFileFromApplicationUriAsync(
    new Uri("ms-appx:///WeedomVoiceReconition.xml"));
            await
    ...
    */
        ...
        private void Application_UnhandledException(object sender, ApplicationUnhandledExceptionEventArgs e)
        {
            ...
            var task = new EmailComposeTask {
                To = "cedric.charpentier@gmail.com",
                Subject = "[Weedom] - Bug",
                Body = @"Exception : " + e.ExceptionObject.Message +
                        "\r\n Stack :" + e.ExceptionObject.StackTrace +
                        "\r\n Source :" + e.ExceptionObject.Source +
                        "\r\n InnerExeption " + e.ExceptionObject.InnerException +
                        "\r\n JsonDashboard : " + (String.IsNullOrEmpty(App.JsonDashboard)?"":App.JsonDashboard) +
                        "\r\n JsonScenario : " + (String.IsNullOrEmpty(App.JsonScenario) ? "" : App.JsonScenario) +
                        "\r\n JsonMessage : " + (String.IsNullOrEmpty(App.JsonMessage)?"":App.JsonMessage) 
